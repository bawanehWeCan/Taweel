...
Route::get('/seed', function () { 
 ...
 Route::get('/noti',  'noticontroller@show')->name('noti');
 Route::get('/send',  'noticontroller@send')->name('send');
 Route::post('/sendnoti',  'noticontroller@send2')->name('sendnoti');




 Route::get('/cats',  'CategoryController@index')->name('cats');
 Route::get('/cats/get-list', [CategoryController::class,'getCatList']);

 Route::get('/cat/delete/{id}',  'CategoryController@destroy')->name('deletecats');
 Route::get('/cat/{id}',  'CategoryController@edit')->name('deletecats');
 Route::post('/cat/update',  'CategoryController@update')->name('updatecat');


 Route::get('/dreams',  'DreamsController@index')->name('dreams');
 Route::get('/dreams/get-list', [DreamsController::class,'getDreamsList']);

 Route::get('/dreams/delete/{id}',  'DreamsController@destroy')->name('deletedreams');
 Route::get('/dreams/{id}',  'DreamsController@show')->name('dcsc');
 Route::get('/dreams/open/{id}',  'DreamsController@openDream')->name('open');
 Route::get('/dreams/{id}/f',  'DreamsController@markf')->name('feat');
 Route::get('/dreams/order/{id}',  'DreamsController@order')->name('orde');
 Route::post('/dreams/update',  'DreamsController@update')->name('updatedreams');
 Route::post('/addreplay',  'DreamsController@addReplay')->name('addreplay');

 Route::post('/changecat',  'DreamsController@changeCat')->name('changecat');
